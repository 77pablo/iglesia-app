...
- **163 firmas en `PENDIENTES` de `xss-cuerpo.test.js`** (eran 199; el lote 1 del 6-ago quemó 36: 12 contadores con `Number()` en código y 25 excepciones verificadas — no-HTML e internos de helpers). Lote sugerido:
