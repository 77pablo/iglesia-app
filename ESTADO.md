...
2. **Configurar push en Railway**: añadir variables `VAPID_PUBLIC`, `VAPID_PRIVATE`, `VAPID_SUBJECT` (ver Fase 5). Sin ellas el push real queda desactivado (las notificaciones siguen en la campana).
3. Vigilar el **crédito de Railway** ("$5.00 left"); pasar a plan si será permanente.
