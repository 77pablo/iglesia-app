...
export function reiniciar(db) {
  ...
  for (const t of ['consentimiento', 'mensaje', 'conversacion_miembro', 'conversacion', 'notificacion', 'recordatorio_enviado', 'push_sub', 'dispositivo_push', 'fecha_no_disp', 'pertenencia', 'grupo', 'persona', 'iglesia'])
