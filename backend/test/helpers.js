...
export function reiniciar(db) {
  ...
  for (const t of ['consentimiento', 'mensaje', 'conversacion_miembro', 'conversacion', 'notificacion', 'recordatorio_enviado', 'push_sub', 'dispositivo_push', 'pertenencia', 'grupo', 'persona', 'iglesia'])
